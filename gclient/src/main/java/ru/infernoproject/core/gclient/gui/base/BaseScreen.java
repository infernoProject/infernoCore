package ru.infernoproject.core.gclient.gui.base;
...
import ru.infernoproject.core.gclient.GameClient;
...
public abstract class BaseScreen implements ScreenController {
    ...
    protected GameClient mainClient = GameClient.APP;
    ...
    public void bind(@Nonnull Nifty nifty, @Nonnull Screen screen) {
        ...
        realmClient = GameClient.APP.realmClientGet();
        worldClient = GameClient.APP.worldClientGet();
