...
public class InfernoConfig {
    ...
    private static Logger logger = LoggerFactory.getLogger(InfernoConfig.class);
    ...
    private InfernoConfig(Map<String, String> config) {
        configData = config;
    }

    public static InfernoConfig readConfig(File configFile) throws IOException {
        ...
        return new InfernoConfig(config);
    }
